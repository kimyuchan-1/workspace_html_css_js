...
let arr9 = [3,1,5,4,2];
console.log(arr9);
arr9.sort((a,b) => a-b); // 기본적으로 문자열로 변환하여 정렬
console.log(arr9);

// 배열 결합 concat 메소드
let arr10 = arr7.concat(arr8);
console.log(arr10);
...
// 배열의 모든 요소를 문자열로 결합 join 메소드
let str = arr10.join("");
console.log(str);

// slice 메소드: 배열의 일부를 잘라내어 새로운 배열로 반환
console.log(arr10.slice(2,4)); // 2~3

// splice 메소드: 배열의 일부를 잘라내어 새로운 배열로 반환, 기존 배열에서 삭제
console.log(arr7.splice(2,2,'A','B')); // 2부터 2개 삭제 후 'A','B' 추가
console.log(arr7);
